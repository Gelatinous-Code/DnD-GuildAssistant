...
export const GAME_TIER_DEFINITIONS: readonly GameTierDefinition[] = [
  { tier: 1, emoji: "1️⃣", label: "Tier 1", levelRange: "Levels 3–4" },
  { tier: 2, emoji: "2️⃣", label: "Tier 2", levelRange: "Levels 5–7" },
  { tier: 3, emoji: "3️⃣", label: "Tier 3", levelRange: "Levels 8+" },
];
